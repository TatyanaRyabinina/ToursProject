...
namespace DAL.Models
{
	public class TourProjectDBInitializer : DropCreateDatabaseAlways<UserContext>
	{
		protected override void Seed(UserContext db)
		{
			...
			db.ExcursionSights.Add(new ExcursionSight { ExcursionId = 2, ExcursionSightName = "Stonehenge" });
			db.ExcursionSights.Add(new ExcursionSight { ExcursionId = 2, ExcursionSightName = "Windsor Castle" });
			db.ExcursionSights.Add(new ExcursionSight { ExcursionId = 2, ExcursionSightName = "Tower of London" });
			db.ExcursionSights.Add(new ExcursionSight { ExcursionId = 2, ExcursionSightName = "Changing of the Guard" });
			...
			db.OrderedTour_ExcursionSights.Add(new OrderedTour_ExcursionSight { OrderedTourId = 1, ExcursionSightId = 11, OrdinalNumber = 0 });
			db.OrderedTour_ExcursionSights.Add(new OrderedTour_ExcursionSight { OrderedTourId = 1, ExcursionSightId = 13, OrdinalNumber = 1 });
			db.OrderedTour_ExcursionSights.Add(new OrderedTour_ExcursionSight { OrderedTourId = 1, ExcursionSightId = 14, OrdinalNumber = 2 });

			db.OrderedTour_ExcursionSights.Add(new OrderedTour_ExcursionSight { OrderedTourId = 2, ExcursionSightId = 7, OrdinalNumber = 0 });
			db.OrderedTour_ExcursionSights.Add(new OrderedTour_ExcursionSight { OrderedTourId = 2, ExcursionSightId = 9, OrdinalNumber = 1 });
			db.OrderedTour_ExcursionSights.Add(new OrderedTour_ExcursionSight { OrderedTourId = 2, ExcursionSightId = 8, OrdinalNumber = 2 });

			db.OrderedTour_ExcursionSights.Add(new OrderedTour_ExcursionSight { OrderedTourId = 3, ExcursionSightId = 12, OrdinalNumber = 0 });
			db.OrderedTour_ExcursionSights.Add(new OrderedTour_ExcursionSight { OrderedTourId = 3, ExcursionSightId = 14, OrdinalNumber = 1 });
			db.OrderedTour_ExcursionSights.Add(new OrderedTour_ExcursionSight { OrderedTourId = 3, ExcursionSightId = 11, OrdinalNumber = 2 });
			db.OrderedTour_ExcursionSights.Add(new OrderedTour_ExcursionSight { OrderedTourId = 3, ExcursionSightId = 13, OrdinalNumber = 3 });
